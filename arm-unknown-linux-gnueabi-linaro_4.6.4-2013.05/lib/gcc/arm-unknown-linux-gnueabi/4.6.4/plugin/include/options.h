...
enum opt_code
{
  ...
  OPT_mabi_ = 944,                           /* -mabi= */
  OPT_mabort_on_noreturn = 945,              /* -mabort-on-noreturn */
  OPT_mandroid = 946,                        /* -mandroid */
  OPT_mapcs = 947,                           /* -mapcs */
  OPT_mapcs_float = 948,                     /* -mapcs-float */
  OPT_mapcs_frame = 949,                     /* -mapcs-frame */
  OPT_mapcs_reentrant = 950,                 /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 951,               /* -mapcs-stack-check */
  OPT_march_ = 952,                          /* -march= */
  OPT_marm = 953,                            /* -marm */
  OPT_mbig_endian = 954,                     /* -mbig-endian */
  OPT_mbionic = 955,                         /* -mbionic */
  OPT_mcallee_super_interworking = 956,      /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 957,      /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 958,       /* -mcirrus-fix-invalid-insns */
  OPT_mcpu_ = 959,                           /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 960,             /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 961,                     /* -mfloat-abi= */
  OPT_mfp16_format_ = 962,                   /* -mfp16-format= */
  OPT_mfp_ = 963,                            /* -mfp= */
  OPT_mfpe = 964,                            /* -mfpe */
  OPT_mfpe_ = 965,                           /* -mfpe= */
  OPT_mfpu_ = 966,                           /* -mfpu= */
  OPT_mglibc = 967,                          /* -mglibc */
  OPT_mhard_float = 968,                     /* -mhard-float */
  OPT_mlittle_endian = 969,                  /* -mlittle-endian */
  OPT_mlong_calls = 970,                     /* -mlong-calls */
  OPT_mpic_register_ = 971,                  /* -mpic-register= */
  OPT_mpoke_function_name = 972,             /* -mpoke-function-name */
  OPT_msched_prolog = 973,                   /* -msched-prolog */
  OPT_msingle_pic_base = 974,                /* -msingle-pic-base */
  OPT_msoft_float = 975,                     /* -msoft-float */
  OPT_mstructure_size_boundary_ = 976,       /* -mstructure-size-boundary= */
  OPT_mthumb = 977,                          /* -mthumb */
  OPT_mthumb_interwork = 978,                /* -mthumb-interwork */
  OPT_mtp_ = 979,                            /* -mtp= */
  OPT_mtpcs_frame = 980,                     /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 981,                /* -mtpcs-leaf-frame */
  OPT_mtune_ = 982,                          /* -mtune= */
  OPT_muclibc = 983,                         /* -muclibc */
  OPT_munaligned_access = 984,               /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 985,     /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 986,       /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 987,               /* -mword-relocations */
  OPT_mwords_little_endian = 988,            /* -mwords-little-endian */
  OPT_n = 989,                               /* -n */
  OPT_no_canonical_prefixes = 990,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 991,               /* -no-integrated-cpp */
  OPT_nocpp = 992,                           /* -nocpp */
  OPT_nodefaultlibs = 993,                   /* -nodefaultlibs */
  OPT_nostartfiles = 994,                    /* -nostartfiles */
  OPT_nostdinc = 995,                        /* -nostdinc */
  OPT_nostdinc__ = 996,                      /* -nostdinc++ */
  OPT_nostdlib = 997,                        /* -nostdlib */
  OPT_o = 998,                               /* -o */
  OPT_p = 999,                               /* -p */
  OPT_pass_exit_codes = 1000,                /* -pass-exit-codes */
  OPT_pedantic = 1001,                       /* -pedantic */
  OPT_pedantic_errors = 1002,                /* -pedantic-errors */
  OPT_pg = 1003,                             /* -pg */
  OPT_pie = 1004,                            /* -pie */
  OPT_pipe = 1005,                           /* -pipe */
  OPT_posix = 1006,                          /* -posix */
  OPT_print_file_name_ = 1007,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1008,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1009,          /* -print-multi-directory */
  OPT_print_multi_lib = 1010,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1011,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1012,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1013,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1014,               /* -print-prog-name= */
  OPT_print_search_dirs = 1015,              /* -print-search-dirs */
  OPT_print_sysroot = 1016,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1017,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1018,                        /* -profile */
  OPT_pthread = 1019,                        /* -pthread */
  OPT_quiet = 1020,                          /* -quiet */
  OPT_r = 1021,                              /* -r */
  OPT_rdynamic = 1022,                       /* -rdynamic */
  ...
  OPT_std_c__98 = 1040,                      /* -std=c++98 */
  OPT_std_c1x = 1041,                        /* -std=c1x */
  /* OPT_std_c89 = 1042, */                  /* -std=c89 */
  OPT_std_c90 = 1043,                        /* -std=c90 */
  OPT_std_c99 = 1044,                        /* -std=c99 */
  /* OPT_std_c9x = 1045, */                  /* -std=c9x */
  OPT_std_f2003 = 1046,                      /* -std=f2003 */
  OPT_std_f2008 = 1047,                      /* -std=f2008 */
  OPT_std_f95 = 1048,                        /* -std=f95 */
  OPT_std_gnu = 1049,                        /* -std=gnu */
  OPT_std_gnu__0x = 1050,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1051,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1052,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1053, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1054,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1055,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1056, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1057, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1058,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1059, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1060, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1061,                     /* -std=legacy */
  OPT_symbolic = 1062,                       /* -symbolic */
  OPT_t = 1063,                              /* -t */
  OPT_time = 1064,                           /* -time */
  OPT_time_ = 1065,                          /* -time= */
  OPT_tno_android_cc = 1066,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1067,                 /* -tno-android-ld */
